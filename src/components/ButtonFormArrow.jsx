...
const ButtonFormArrow = ({text,marginTop}) => {
      return (
            <div className={`mx-auto w-[45%] ${marginTop} relative bg-primary py-4 text-center text-white text-base font-medium overflow-clip cursor-pointer`} style={workSans.style}>
			{text}
