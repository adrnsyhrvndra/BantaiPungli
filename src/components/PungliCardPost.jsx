...
const PungliCardPost = ({imageSizeWidth,imageSizeHeight,judulTextSize,deskripsiTextSize, judul_pelaporan,deskripsi_pelaporan,tanggal_pelaporan,status_pelaporan,bukti_pendukung,created_at,updated_at,kategoriPungliId,userId,id,dataKomentarLaporanPungli}) => {

      const [gambarBuktiPendukung, setGambarBuktiPendukung] = useState();
      const [fotoProfile, setFotoProfile] = useState();
      const [arrayIdLaporan, setArrayIdLaporan] = useState([]);

      console.log(kategoriPungliId);
      ...
      }, [bukti_pendukung, userId.foto_profile, id]);
