...
const CardHomeProfile = ({nama_lengkap}) => {
      ...
      const handleFotoProfile = (fotos_profile) => {
            if (fotos_profile === undefined) {
                  return 'https://res.cloudinary.com/adriansyah-course-laravel7/image/upload/v1720332399/bantai-pungli/Ellipse_2_jpmd5y.png';
            } else {
                  return fotos_profile;
            }
      }
            ...
            <div className='bg-white rounded-lg h-fit'>
                  ...
                  <div className='mt-8 flex flex-row justify-start gap-6 px-6 pb-6'>
                        <div className='w-36 h-36 rounded-full bg-slate-500 -mt-20 border-2 border-white relative'>
                              <Image className='rounded-full object-cover object-center' src={handleFotoProfile(fotoProfile)} fill={true} alt='profile-user-bantai-pungli' />
                        </div>
